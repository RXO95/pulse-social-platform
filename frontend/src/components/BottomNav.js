  ...
  const navItems = [
    ...
    },
    {
      ...
      icon: (active) => (
        <svg viewBox="0 0 24 24" width="24" height="24" fill={active ? t.accentBlue : t.textSecondary}>
          {active ? (
            <path d="M1.998 5.5c0-1.381 1.119-2.5 2.5-2.5h15c1.381 0 2.5 1.119 2.5 2.5v13c0 1.381-1.119 2.5-2.5 2.5h-15c-1.381 0-2.5-1.119-2.5-2.5v-13zm2.5-.5c-.276 0-.5.224-.5.5v2.764l8 5.14 8-5.14V5.5c0-.276-.224-.5-.5-.5h-15zM19.998 9.971l-8 5.14-8-5.14V18.5c0 .276.224.5.5.5h15c.276 0 .5-.224.5-.5v-8.529z"/>
          ) : (
